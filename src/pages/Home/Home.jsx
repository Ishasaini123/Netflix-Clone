    ...
    <div className='home'>
         ...
         <div className="hero">
          ...
          {/* <div className="hero-caption">
            ...
            <p>Discovering his ties to a secret ancient order , a young man living in modern Istanbul embarks on a quest to save the city from an immortal enenmy.</p>
          ...
          <div className="hero-caption">
            ...
            <div className="hero-btns">
              ...
              <button className='btn dark-btn'><img src={info_icon} alt="info_icon" />Info</button>
            </div>
            <TitleCards/>
          </div>
         </div>
